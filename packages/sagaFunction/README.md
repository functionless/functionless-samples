# The (Functionless) Saga Step Function
...
![flow](img/functionless_saga_success.png)
...
Both examples use the same [Dynamo Table](#dynamodb-table) and a similar API.
